...
<html lang="en">
    ...
    <body class="font-serif bg-blue text-white noice-bg">
    	<svg id="light-mode-toggle" class="absolute pin-r m-6 fill-current text-white" width="60" height="60" viewBox="0 0 200 200" opacity="0.5" xmlns="http://www.w3.org/2000/svg">
